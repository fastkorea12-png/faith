const stages = [
  {
    ...
    mission:
      "서로 맞지 않는 도착 기록들 사이에서, 이 조사팀에게 실제로 일어난 일을 밝혀내십시오.",
  ...
  },
  {
    ...
    mission:
      "누군가 쉬어 갔던 자리들을 추적해, 멈춰 버린 길의 끝에 남겨진 물건을 회수하십시오.",
  ...
  },
  {
    ...
    mission:
      "여러 이름으로 자신을 남긴 휴대폰 주인이 끝까지 바꾸지 않았던 단 하나의 기록을 찾으십시오.",
  ...
  },
  {
    ...
    mission:
      "제자리를 잃은 물품과 바뀐 기록을 복원해, 맡겨진 것을 자기 뜻대로 바꾼 사람을 밝혀내십시오.",
  ...
  },
  {
    ...
    mission:
      "같은 자리로 되돌아오는 길에 남은 네 사람의 기억을 모아, 반복을 끊을 한 번의 선택을 찾으십시오.",
  ...
  },
  {
    ...
    mission:
      "다섯 현장에서 회수한 기록이 가리키는 하나의 고백을 찾아, 이 사건의 마지막 빈칸을 완성하십시오.",
